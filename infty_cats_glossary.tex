...
\hline
Monoidal category & \textcolour{red}{[todo]} & \textcolour{red}{Cocartesian fibration of \(\infty\)-operads \(\mathcal{C}^\otimes \to \text{Assoc}^\otimes\). (\autocite{ha}, Def 4.1.1.10)} & \textcolour{red}{[todo]}\\
\hline
(Coloured) operad & 
...
\(\bullet\) Units \(\id_X \in \Hom(\{X\}, X)\). (\autocite{ha}, Def 2.1.1.1)
 & A functor \(p : \mathcal{O}^\otimes \to N(\textbf{Fin}_*)\) between \(\infty\)-categories which satisfies the following conditions:
...
\begin{longtable}{ |p{5cm}||p{8cm}|}
 ...
 Name & Definition\\
  \hline\hline
\textbf{Assoc} & \textcolour{red}{\autocite{ha}, Def 4.1.1.1}\\
\hline
\(\text{Assoc}^\otimes\) (the associative \(\infty\)-operad) & \(N(\textbf{Assoc}^\otimes)\). (\autocite{ha}, Def 4.1.1.3) \\
\hline
\(\textbf{Assoc}^\otimes\) &\textcolour{red}{\autocite{ha}, Def 4.1.1.3}\\
\hline 
