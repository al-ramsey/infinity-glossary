...
\begin{longtable}{ |p{3.2cm}||p{5cm}|p{5.2cm}|p{5cm}|  }
 ...
 \hline\hline
 Accessible category & \textcolour{red}{[todo]} & \textcolour{red}{[todo]} & \textcolour{red}{[todo]}\\
 \hline
...
\hline
\(\kappa\)-Compact object & \textcolour{red}{[todo]} & \textcolour{red}{[todo]} & \textcolour{red}{[todo]}\\
\hline
\(\kappa\)-Continuous functor & \textcolour{red}{[todo]} & \textcolour{red}{[todo]} & \textcolour{red}{[todo]}\\
\hline
...
\hline
\(\kappa\)-Filtered category & \textcolour{red}{[todo]} & \textcolour{red}{[todo]} & \textcolour{red}{[todo]}\\
\hline
...
\begin{tabular}{ |p{5cm}||p{8cm}|}
 ...
 Name & Definition\\
  \hline\hline
\textbf{Kan} & The full subcategory of \textbf{sSet} spanned by the collection of Kan complexes (\autocite{htt}, Def 1.2.16.1) \\ 
 \hline
  \(\infty\)-Category of spaces \(\mathcal{S}\) & The simplicial\footnotemark nerve \(N(\textbf{Kan})\).\\
  \hline 
\end{tabular}
...
% what is LaTeX's fucking problem?? How hard is it to let someone put a footnote in a table?
